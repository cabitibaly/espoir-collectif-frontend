    ...
    return (
        <section className="w-full h-screen z-40 flex items-center justify-center bg-hero-bg bg-no-repeat bg-cover">
            <div className="w-2/5 p-4 flex items-center justify-center flex-col gap-2 max-1090:w-full max-750:p-10">
                ...
                <Link to="/creer-une-cagnote" className="w-52 p-3 mt-4 text-center text-white text-lg font-semibold bg-green-700 rounded-xl transition duration-300 ease-in-out hover:bg-white hover:text-black">Creer une cagnote</Link>
            </div>
        </section>
    );
};
